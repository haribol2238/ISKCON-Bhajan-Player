...
private val DarkColorScheme =
  darkColorScheme(
    ...
    tertiary = SandstoneLight,
    background = MidnightBackground,
    surface = DuskSurface,
    onPrimary = Color(0xFF120E0C),
    onSecondary = Color(0xFF120E0C),
...
private val LightColorScheme =
  lightColorScheme(
    ...
    tertiary = SandstoneDark,
    background = IvoryBackground,
    surface = IvorySurface,
    onPrimary = Color.White,
    onSecondary = Color.White,
    onBackground = Color(0xFF1E1714),
    onSurface = Color(0xFF1E1714)
  )
